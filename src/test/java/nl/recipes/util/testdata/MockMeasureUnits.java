...
public class MockMeasureUnits {
  ...
  public ObservableList<MeasureUnit> getMeasureUnitList() {
    ...
    measureUnitList.add(new MeasureUnit.MeasureUnitBuilder().withName("eetlepel")
        .withPluralName("eetlepels").build(2L));
    measureUnitList.add(
        new MeasureUnit.MeasureUnitBuilder().withName("pot").withPluralName("potten").build(3L));
    measureUnitList.add(new MeasureUnit.MeasureUnitBuilder().withName("theelepel")
