...
public class MockIngredientNames {
  ...
  public ObservableList<IngredientName> getIngredientNameList() {
    ...
    ingredientNameList.add(new IngredientName.IngredientNameBuilder().withMeasureUnit(null)
    ...
    ingredientNameList.add(new IngredientName.IngredientNameBuilder().withMeasureUnit(null)
        ...
        .withIngredientType(IngredientType.GROENTE).build(2L));
    ingredientNameList.add(new IngredientName.IngredientNameBuilder().withMeasureUnit(null)
    ...
    ingredientNameList.add(new IngredientName.IngredientNameBuilder()
        .withMeasureUnit(
            new MeasureUnit.MeasureUnitBuilder().withName("bol").withPluralName("bollen").build(3L))
        .withName("mozzarella").withPluralName("mozzarella").withStock(true)
        .withShopType(ShopType.DEKA).withIngredientType(IngredientType.ZUIVEL).build(4L));
