...
public class GoogleSheetService {
  ...
  public boolean deleteStoredCredentials() {
    ...
    Path storedCredentialsPath =
        Path.of(rootPath.toString(), TOKENS_DIRECTORY_PATH, "StoredCredential");
  ...
  private int prepareSpreadsheet(String spreadsheetId, int listSize, int startRow, int headerIndex)
    ...
    Request headerCopyPasteRequest = new Request().setCopyPaste(new CopyPasteRequest()
        .setSource(new GridRange().setSheetId(Integer.valueOf(templateSheetId))
            .setStartRowIndex(headerIndex).setEndRowIndex(headerIndex + 1).setStartColumnIndex(0)
            .setEndColumnIndex(4))
        .setDestination(
            new GridRange().setSheetId(Integer.valueOf(shoppingSheetId)).setStartRowIndex(rowIndex)
  ...
  private Request requestRowWithSelection(int rowIndex) {
    return new Request().setCopyPaste(new CopyPasteRequest()
        .setSource(new GridRange().setSheetId(Integer.valueOf(templateSheetId)).setStartRowIndex(4)
            .setEndRowIndex(5).setStartColumnIndex(0).setEndColumnIndex(4))
        .setDestination(
            new GridRange().setSheetId(Integer.valueOf(shoppingSheetId)).setStartRowIndex(rowIndex)
  ...
  private Request requestEmptyRow(int rowIndex) {
    return new Request().setCopyPaste(new CopyPasteRequest()
        .setSource(new GridRange().setSheetId(Integer.valueOf(templateSheetId)).setStartRowIndex(5)
            .setEndRowIndex(6).setStartColumnIndex(0).setEndColumnIndex(4))
        .setDestination(
            new GridRange().setSheetId(Integer.valueOf(shoppingSheetId)).setStartRowIndex(rowIndex)
                .setEndRowIndex(rowIndex + 1).setStartColumnIndex(0).setEndColumnIndex(4))
        .setPasteType("PASTE_NORMAL").setPasteOrientation("NORMAL"));
