...
public class BootstrapColumn {
  ...
  int[] columnWidths = new int[] {1, // XS (default)
      -1, // Sm
      -1, // Md
      -1, // Lg
      -1 // XL
  ...
  public void unsetAllBreakPoints() {
    this.columnWidths = new int[] {1, // XS (default)
        -1, // Sm
        -1, // Md
        -1, // Lg
        -1 // XL
  ...
  /**
   * Iterate through breakpoints, beginning at the specified bp, travelling down. Return first valid
   * bp value. If none are valid, return 1
   * 
   * @param breakPoint the breakpoint at which to determine the column width
   * @return the requested width at that breakpoint, or based on a lower breakpoint if the specified
   *         bp has not been set.
   */
  public int getColumnWidth(Breakpoint breakPoint) {

    // Iterate through breakpoints, beginning at the specified bp, travelling down.
    // Return first valid bp value.
