...
@Slf4j
public class ImprovedShoppingPanel {
  ...
  private ImprovedShoppingPanel() {}
  
  private ImprovedShoppingPanel(ShoppingPanelBuilder builder) {
  ...
  public static class ShoppingPanelBuilder {
    ...
    public ImprovedShoppingPanel build() {
      return new ImprovedShoppingPanel(this);
    }
  }
  ...
  private HBox createTableView() {
    ...
    nameColumn.setCellValueFactory(c -> new ReadOnlyObjectWrapper<>(c.getValue().getLabel()));
