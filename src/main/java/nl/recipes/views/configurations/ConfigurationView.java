...
public class ConfigurationView {
	...
	public ConfigurationView(TagEditPanel tagEditPanel, MeasureUnitEditPanel measureUnitEditPanel,
			IngredientNameTableEditWidget ingredientNameTableEditWidget,
			ShoppingItemTableEditWidget shoppingItemTableEditWidget, StockShoppingEditPanel stockShoppingEditPanel) {
		...
		scrollPane.widthProperty().addListener((observable, oldValue, newValue) -> root.notifyWidthChange(newValue));
	}
