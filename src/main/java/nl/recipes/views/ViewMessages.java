...
public final class ViewMessages {
  ...
  public static final String PROGRAM_TITLE = "Recepten-planner versie 1.1.0";
  ...
  public static final String REMOVE = "Verwijderen";
  public static final String CREATE = "Toevoegen";
  public static final String COLON = ":";
  public static final String _ALREADY_EXISTS = " bestaat al";
  public static final String _NOT_FOUND = " niet gevonden";

  public static final String TAG = "Categorie";
  public static final String TAG_ = "Categorie ";
  public static final String EDIT_TAGS = "Categoriëen bewerken";
  public static final String TAG_NAME_CANNOT_BE_EMPTY = "Categorie naam mag niet leeg zijn";

  public static final String MEASURE_UNIT = "Maateenheid";
  ...
  public static final String INGREDIENT_NAME_NAME_CANNOT_BE_EMPTY =
      "Ingrediënt naam mag niet leeg zijn";
  ...
  public static final String SELECT_STOCK_SHOPPINGS = "Selecteer voorraad boodschappen";
  public static final String SELECT_RECIPE_SHOPPINGS = "Boodschappen voor recepten";
  public static final String STOCK_SHOPPINGS = "Benodigd uit voorraad";
  public static final String SELECT_STANDARD_SHOPPINGS = "Selecteer standaard boodschappen";
  public static final String SELECT_ONETIME_SHOPPINGS = "Selecteer eenmalige boodschappen";
}
